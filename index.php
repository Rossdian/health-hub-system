                        ...
                        <div class="navbar-content d-flex justify-content-between align-items-center">
                            <div class = "brand-and-toggler d-flex align-items-center justify-content-between">
                                <a href = "#" class = "navbar-brand d-flex align-items-center">
                                    ...
                                    <span class="brand-text fw-7">Health Hub</span>
                                </a>
                        ...
                        <div class="banner-content">
                            <div class="banner-left">
                                <div class="content-wrapper">
                                    ...
                                    <p class="text text-white">Health Hub provides progressive, and affordable healthcare, accessible on mobile and onnline for everyone</p>
                                    <a href = "log_in.php" class="btn btn-secondary">SIGN UP</a>
                                </div>
                            </div>
                        ...
                        <div class = "grid-content d-grid align-items-center">
                            ...
                            <div class = "grid-text">
                                <div class = "content-wrapper text-start">
                                    ...
                                    <p class = "text title-box-text text-white">Health Hub provides progressive, and affordable healthcare, accessible on mobile and online for everyone. To us, it's not just work. We take pride in the solutions we deliver</p>
                    ...
                    <div class = "footer-content">
                        <div class = "footer-list d-grid text-white">
                            <div class = "footer-item">
                                ...
                                <p class = "text-white">Health Hub provides progressive, and affordable healthcare, accessible on mobile and online for everyone</p>
                                <p class = "text-white copyright-text">&copy; Health Hub PTY LTD 2023. All rights reserved.</p>
                            </div>
